...
void CreateScene(){
  ...
  planeObject.material = cache.GetResource("Material", "Materials/StoneTiled_dithered.xml");
  ...
  for (uint i = 0; i < NUM_OBJECTS; ++i)
  {
    ...
    Material@ mat = cache.GetResource("Material", "Materials/Mushroom_dithered.xml");
...
void SetupViewport()
{
  ...
  XMLFile@ xml = cache.GetResource("XMLFile", "RenderPaths/Dithered_palette.xml");
