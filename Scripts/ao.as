...
void CreateScene(){
  ...
  planeObject.material = cache.GetResource("Material", "Materials/Normal.xml");
  ...
  for (uint i = 0; i < NUM_OBJECTS; ++i)
  {
    ...
    Material@ mat = cache.GetResource("Material", "Materials/Normal.xml");
...
void SetupViewport()
{
  ...
  XMLFile@ xml = cache.GetResource("XMLFile", "RenderPaths/ao.xml");
